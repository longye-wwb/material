 ...
 ************************************************************
**/
public class MicrowavePhaseEntityDataDto {
     ...
     * 交叉极化幅度
     */
    private List<CrossPolarizationDataDto> dataArr;
    ...
    public MicrowavePhaseEntityDataDto() {
    }
    ...
    public List<CrossPolarizationDataDto> getDataArr() {
        return dataArr;
    }

    public void setDataArr(List<CrossPolarizationDataDto> dataArr) {
