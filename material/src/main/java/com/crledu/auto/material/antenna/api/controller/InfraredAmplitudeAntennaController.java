 ...
 ************************************************************
**/
@Api(tags = "光电-红外宽带振幅转换")
@RestController
@RequestMapping("infrared_amplitude")
public class InfraredAmplitudeAntennaController extends AbstractController {

    @Resource
    private BaseInfraredAmplitudeImportService importService;

    @Resource
    private BaseInfraredAmplitudeDataService dataService;
