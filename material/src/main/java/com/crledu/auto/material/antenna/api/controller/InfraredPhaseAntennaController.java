 ...
 ************************************************************
**/
@Api(tags = "光电-红外宽带位相调控")
@RestController
@RequestMapping("infrared_phase")
public class InfraredPhaseAntennaController extends AbstractController {

    @Resource
    private BaseInfraredPhaseImportService importService;

    @Resource
    private BaseInfraredPhaseDataService dataService;
